 ...
 * under the License.
 */
package org.ninedragon.extlib.io.netty.channel;

import static org.ninedragon.extlib.io.netty.channel.DefaultChannelPipeline.*;

import java.net.SocketAddress;

import org.ninedragon.extlib.io.netty.buffer.ByteBufAllocator;
import org.ninedragon.extlib.io.netty.util.DefaultAttributeMap;
import org.ninedragon.extlib.io.netty.util.Recycler;
import org.ninedragon.extlib.io.netty.util.ReferenceCountUtil;
import org.ninedragon.extlib.io.netty.util.concurrent.EventExecutor;
import org.ninedragon.extlib.io.netty.util.internal.OneTimeTask;
import org.ninedragon.extlib.io.netty.util.internal.RecyclableMpscLinkedQueueNode;
...
abstract class AbstractChannelHandlerContext extends DefaultAttributeMap implements ChannelHandlerContext {
    ...
    abstract static class AbstractWriteTask extends RecyclableMpscLinkedQueueNode<Runnable> implements Runnable {
        ...
        private static final boolean ESTIMATE_TASK_SIZE_ON_SUBMIT =
                SystemPropertyUtil.getBoolean("org.ninedragon.extlib.io.netty.transport.estimateSizeOnSubmit", true);

        // Assuming a 64-bit JVM, 16 bytes object header, 3 reference fields and one int field, plus alignment
        private static final int WRITE_TASK_OVERHEAD =
                SystemPropertyUtil.getInt("org.ninedragon.extlib.io.netty.transport.writeTaskSizeOverhead", 48);
