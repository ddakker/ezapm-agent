...
public final class NativeLibraryLoader {
    ...
    static {
        ...
        String workdir = SystemPropertyUtil.get("org.ninedragon.extlib.io.netty.native.workdir");
        if (workdir != null) {
            ...
            WORKDIR = tmpdir();
            logger.debug("-Dio.netty.native.workdir: " + WORKDIR + " (org.ninedragon.extlib.io.netty.tmpdir)");
        }
    }
