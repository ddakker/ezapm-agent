 ...
 * {@link org.ninedragon.extlib.io.netty.buffer.ByteBuf}, has been designed from ground
 ...
 * <h3>Extensibility</h3>
 *
 * {@link org.ninedragon.extlib.io.netty.buffer.ByteBuf} has rich set of operations
 * optimized for rapid protocol implementation.  For example,
 * {@link org.ninedragon.extlib.io.netty.buffer.ByteBuf} provides various operations
 ...
 * {@link org.ninedragon.extlib.io.netty.buffer.ByteBuf} interface rather than
 ...
 * </pre>
 * By contrast, {@link org.ninedragon.extlib.io.netty.buffer.ByteBuf} does not have such
 ...
 * {@link org.ninedragon.extlib.io.netty.buffer.ByteBuf} is a very thin wrapper of a
