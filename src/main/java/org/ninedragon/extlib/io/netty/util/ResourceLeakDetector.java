...
package org.ninedragon.extlib.io.netty.util;

import static org.ninedragon.extlib.io.netty.util.internal.StringUtil.*;
...
import org.ninedragon.extlib.io.netty.util.internal.MathUtil;
...
public final class ResourceLeakDetector<T> {
    ...
    private static final String PROP_LEVEL_OLD = "org.ninedragon.extlib.io.netty.leakDetectionLevel";
    private static final String PROP_LEVEL = "org.ninedragon.extlib.io.netty.leakDetection.level";
    private static final Level DEFAULT_LEVEL = Level.SIMPLE;

    private static final String PROP_MAX_RECORDS = "org.ninedragon.extlib.io.netty.leakDetection.maxRecords";
    ...
    static {
        ...
        if (SystemPropertyUtil.get("org.ninedragon.extlib.io.netty.noResourceLeakDetection") != null) {
            disabled = SystemPropertyUtil.getBoolean("org.ninedragon.extlib.io.netty.noResourceLeakDetection", false);
    ...
    private static final String[] STACK_TRACE_ELEMENT_EXCLUSIONS = {
            "org.ninedragon.extlib.io.netty.buffer.AbstractByteBufAllocator.toLeakAwareBuffer(",
            "org.ninedragon.extlib.io.netty.buffer.AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation("
    };
