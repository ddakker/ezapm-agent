...
package org.ninedragon.extlib.javassist.bytecode.stackmap;
...
public class MapMaker extends Tracer {
    ...
    public static void main1(String className) throws Exception {
        ...
        //org.ninedragon.extlib.javassist.CtClass cc = cp.get(className);
        org.ninedragon.extlib.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(className));
    ...
    public static void main2(String[] args) throws Exception {
        ClassPool cp = ClassPool.getDefault();
        //org.ninedragon.extlib.javassist.CtClass cc = cp.get(args[1]);
        org.ninedragon.extlib.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(args[1]));
        MethodInfo minfo;
    ...
    */
     ...
     * See org.ninedragon.extlib.javassist.JvstTest4.testJIRA195().
     */
