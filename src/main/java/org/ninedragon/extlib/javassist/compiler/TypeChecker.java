    ...
    protected CtField fieldAccess(ASTree expr) throws CompileError {
        if (expr instanceof Member) {
            ...
            if (op == MEMBER) {
                 ...
                 *
                 * class Foo {
                 *   int org.ninedragon.extlib.javassist;
                 * }
                 *
                 * It is impossible to add the following method:
                 *
                 * String m() { return org.ninedragon.extlib.javassist.CtClass.intType.toString(); }
                 *
                 * because org.ninedragon.extlib.javassist is a field name.  However, this is
