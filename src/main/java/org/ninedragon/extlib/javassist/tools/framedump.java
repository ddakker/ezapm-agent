 ...
 * License.
 */
package org.ninedragon.extlib.javassist.tools;

import org.ninedragon.extlib.javassist.ClassPool;
import org.ninedragon.extlib.javassist.CtClass;
import org.ninedragon.extlib.javassist.bytecode.analysis.FramePrinter;
 ...
 *
 * <p>For example,
 * <pre>% java org.ninedragon.extlib.javassist.tools.framedump foo.class</pre>
 */
public class framedump {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 1) {
            System.err.println("Usage: java org.ninedragon.extlib.javassist.tools.framedump <fully-qualified class name>");
            return;
        }
