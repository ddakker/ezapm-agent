...
import static org.ezdevgroup.extlib.io.netty.util.internal.MathUtil.isOutOfBounds;
import static org.ezdevgroup.extlib.io.netty.util.internal.ObjectUtil.checkNotNull;
import static org.ezdevgroup.extlib.io.netty.util.internal.StringUtil.NEWLINE;
import static org.ezdevgroup.extlib.io.netty.util.internal.StringUtil.isSurrogate;
...
import org.ezdevgroup.extlib.io.netty.util.Recycler;
import org.ezdevgroup.extlib.io.netty.util.Recycler.Handle;
...
import org.ezdevgroup.extlib.io.netty.util.internal.StringUtil;
...
public final class ByteBufUtil {
    ...
    static {
        String allocType = SystemPropertyUtil.get("org.ninedragon.extlib.io.netty.allocator.type", "unpooled").toLowerCase(Locale.US).trim();
        ...
        THREAD_LOCAL_BUFFER_SIZE = SystemPropertyUtil.getInt("org.ninedragon.extlib.io.netty.threadLocalDirectBufferSize", 64 * 1024);
        logger.debug("-Dio.netty.threadLocalDirectBufferSize: {}", THREAD_LOCAL_BUFFER_SIZE);

        MAX_CHAR_BUFFER_SIZE = SystemPropertyUtil.getInt("org.ninedragon.extlib.io.netty.maxThreadLocalCharBufferSize", 16 * 1024);
