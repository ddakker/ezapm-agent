...
package org.ezdevgroup.extlib.javassist.tools.rmi;
...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "org.ninedragon.extlib.javassist.tools.rmi.Sample";
     ...
     * This is a method declared in org.ninedragon.extlib.javassist.Translator.
     *
     * @see org.ezdevgroup.extlib.javassist.Translator#start(ClassPool)
     */
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "org.ninedragon.extlib.javassist.tools.rmi.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "org.ninedragon.extlib.javassist.tools.rmi.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("org.ninedragon.extlib.javassist.tools.rmi.RemoteException") };
    }

    /**
     * Does nothing.
     * This is a method declared in org.ninedragon.extlib.javassist.Translator.
     * @see org.ezdevgroup.extlib.javassist.Translator#onLoad(ClassPool,String)
     */
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("org.ninedragon.extlib.javassist.tools.rmi.ObjectImporter"),
                          fieldImporter, proxy);
