...
package org.ezdevgroup.extlib.javassist.tools.reflect;
 ...
 *     org.ninedragon.extlib.javassist.tools.reflect.Loader cl
 *         = (org.ninedragon.extlib.javassist.tools.reflect.Loader)Main.class.getClassLoader();
 *     cl.makeReflective("Person", "MyMetaobject",
 *                       "org.ninedragon.extlib.javassist.tools.reflect.ClassMetaobject");
 *     cl.run("MyApp", args);
 *   }
 * }
 * </pre>
 ...
 *
 * <pre>% java org.ninedragon.extlib.javassist.tools.reflect.Loader Main arg1, ...</pre>
 *
 ...
 * public class Main2 {
 *   public static void main(String[] args) throws Throwable {
 *     org.ninedragon.extlib.javassist.tools.reflect.Loader cl = new org.ninedragon.extlib.javassist.tools.reflect.Loader();
 *     cl.makeReflective("Person", "MyMetaobject",
 *                       "org.ninedragon.extlib.javassist.tools.reflect.ClassMetaobject");
 *     cl.run("MyApp", args);
 *   }
 ...
 * is loaded by <code>org.ninedragon.extlib.javassist.tools.reflect.Loader</code> whereas the class
 ...
 * to the same name space as <code>org.ninedragon.extlib.javassist.tools.reflect.Loader</code>.
 * For more details,
 * see the notes in the manual page of <code>org.ninedragon.extlib.javassist.Loader</code>.
 *
 ...
 *     org.ninedragon.extlib.javassist.Loader cl
 *         = new org.ninedragon.extlib.javassist.Loader(ClassPool.getDefault(reflection));
 ...
 * <p><b>Note:</b>
 *
 * <p><code>org.ninedragon.extlib.javassist.tools.reflect.Loader</code> does not make a class reflective
 ...
 * modified with <code>org.ninedragon.extlib.javassist.tools.reflect.Compiler</code> and the original
 * class files should be replaced.
 *
 * @see org.ezdevgroup.extlib.javassist.tools.reflect.Reflection
 * @see org.ezdevgroup.extlib.javassist.tools.reflect.Compiler
 * @see org.ezdevgroup.extlib.javassist.Loader
 */
public class Loader extends org.ezdevgroup.extlib.javassist.Loader {
    ...
    public Loader() throws CannotCompileException, NotFoundException {
        super();
        delegateLoadingOf("org.ninedragon.extlib.javassist.tools.reflect.Loader");
     ...
     *
     * @see org.ezdevgroup.extlib.javassist.tools.reflect.Metaobject
     * @see org.ezdevgroup.extlib.javassist.tools.reflect.ClassMetaobject
     */
