...
package org.ezdevgroup.extlib.javassist.util.proxy;
...
import org.ezdevgroup.extlib.javassist.bytecode.*;
 ...
 * with previous releases of org.ninedragon.extlib.javassist. Unfortunately,this legacy behaviour makes caching
 * and reuse of proxy classes impossible. The current programming model expects org.ninedragon.extlib.javassist
 ...
 * {@link org.ezdevgroup.extlib.javassist.util.proxy.ProxyObjectOutputStream} and {@link org.ezdevgroup.extlib.javassist.util.proxy.ProxyObjectInputStream}
 * (which are subclasses of {@link java.io.ObjectOutputStream} and  {@link java.io.ObjectInputStream})
 * to serialize and deserialize, respectively, the proxy. These streams recognise org.ninedragon.extlib.javassist proxies and ensure
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "org.ninedragon.extlib.javassist.util.proxy.RuntimeSupport";
     ...
     * setting retains the old org.ninedragon.extlib.javassist behaviour which has the advantage that it
    ...
    /**
     * determine if a class is a org.ninedragon.extlib.javassist proxy class
     * @param cl
     * @return true if the class is a org.ninedragon.extlib.javassist proxy class otherwise false
     */
    ...
    protected ClassLoader getClassLoader0() {
        ...
        if (loader == null) {
            ...
            // In case org.ninedragon.extlib.javassist is in the endorsed dir
            if (loader == null) {
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("org.ninedragon.extlib.javassist.util.proxy.RuntimeSupport",
                             "makeSerializedProxy",
